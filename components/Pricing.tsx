    ...
    <section id="pricing" style={{ padding: "90px 24px", background: "#080808" }}>
      <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
        ...
        <p style={{ textAlign: "center", fontSize: "12px", color: "#4b5563", marginTop: "14px", maxWidth: "520px", margin: "14px auto 0", lineHeight: 1.6 }}>
          One home, one connection — simple as that. Two devices in the same home share one connection. Second home or different location (ex: cabin at the lake)? You&apos;ll need a second account.
        </p>
      </div>
    </section>
  );
